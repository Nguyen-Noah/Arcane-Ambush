...
def create_weapon(game, owner, weapon_type, tags=[]):
    if weapon_type in WEAPONS:
        return WEAPONS[weapon_type](game, owner, weapon_type, tags=tags)
    else:
        return Weapon(game, owner, weapon_type, tags=tags)